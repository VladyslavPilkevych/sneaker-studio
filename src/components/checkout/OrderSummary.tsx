  ...
  return (
    <div className="layout-content-container flex flex-col w-[360px]">
      {items.map((item) => (
        <div
          key={item.id}
          className="flex items-center gap-4 bg-[#111722] px-4 py-3"
        >
          <div
      ...
      <div className="flex px-4 py-3">
        <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 flex-1 bg-[#135bec] text-white text-base font-bold leading-normal tracking-[0.015em]">
